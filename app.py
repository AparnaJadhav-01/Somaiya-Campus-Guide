...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///C:/Users/Sandeep Jadhav/sqlite/dbs/coordinates.db'
...
def ont():
    try:
        sqliteConnection = sqlite3.connect('C:/Users/Sandeep Jadhav/sqlite/dbs/coordinates.db')
